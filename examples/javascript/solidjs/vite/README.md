...
[![StackBlitz](https://img.shields.io/badge/try_on-stackblitz-blue?logo=stackblitz)](https://stackblitz.com/github/Interview-Challenge-Archive/document-markdown-reader/tree/main/examples/javascript/solidjs/vite)
...
- `src/index.jsx` - The entry point that renders the SolidJS application
- `index.html` - The HTML page where your app loads
- `src/App.css` - The styles for the application
- `vite.config.js` - Vite configuration with SolidJS plugin

# JavaScript React Parcel Example

This example shows how to use the document-markdown-reader library in a web application built with [React](https://react.dev/) and [Parcel](https://parceljs.org/).
...
- `src/App.jsx` - The main React component that handles file selection and conversion
- `src/index.jsx` - The entry point that renders the React application

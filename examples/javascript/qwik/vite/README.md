# JavaScript Qwik Vite Example

This example shows how to use the document-markdown-reader library in a web application built with [Qwik](https://qwik.dev/) and [Vite](https://vitejs.dev/).
...
[![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/Interview-Challenge-Archive/document-markdown-reader/tree/main/examples/javascript/qwik/vite)
...
- `src/main.jsx` - Renders the Qwik UI and handles file conversion

# JavaScript Alpine.js Vite Example

This example shows how to use the document-markdown-reader library in a web application built with [Alpine.js](https://alpinejs.dev/) and [Vite](https://vitejs.dev/).
...
[![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/Interview-Challenge-Archive/document-markdown-reader/tree/main/examples/javascript/alpinejs/vite)
...
- `src/main.js` - Registers Alpine data and conversion logic

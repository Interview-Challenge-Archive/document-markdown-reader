# TypeScript Lit Vite Example

This example shows how to use the document-markdown-reader library in a web application built with [Lit](https://lit.dev/), TypeScript, and [Vite](https://vitejs.dev/).
...
[![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/Interview-Challenge-Archive/document-markdown-reader/tree/main/examples/typescript/lit/vite)
...
- `src/main.ts` - Defines the Lit component and conversion flow

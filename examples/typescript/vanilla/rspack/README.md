# TypeScript Vanilla Rspack Example

This example shows how to use the document-markdown-reader library in a web application built with vanilla TypeScript and [Rspack](https://www.rspack.dev/).
...
[![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/Interview-Challenge-Archive/document-markdown-reader/tree/main/examples/typescript/vanilla/rspack)
...
Rspack is a high-performance bundler written in Rust that is fully compatible with Webpack's configuration. It provides blazing fast build speeds while maintaining compatibility with the Webpack ecosystem.
...
- `rspack.config.js` - Configuration for the Rspack bundler

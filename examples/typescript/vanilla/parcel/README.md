...
# TypeScript Vanilla Parcel Example

This example shows how to use the document-markdown-reader library in a web application built with vanilla TypeScript and [Parcel](https://parceljs.org/).
